...
(function($){	
	...
	var get = {
		...
		defaultPreloader: function(prependTo, transitions, prefix){
			...
			$("head").append("<style>#sequence-preloader{height: 100%;position: absolute;width: 100%;z-index: 999999;}@"+prefix+"keyframes preload{0%{opacity: 0;}50%{opacity: 1;}100%{opacity: 0;}}#sequence-preloader img{background: #858585;border-radius: 6px;display: inline-block;height: 10px;opacity: "+opacity+";position: relative;top: -50%;width: 10px;"+prefix+"animation: preload 1s infinite; animation: preload 1s infinite;}.preloading{height: 10px;margin: 0 auto;top: 50%;position: relative;width: 48px;}#sequence-preloader img:nth-child(2){"+prefix+"animation-delay: .15s; animation-delay: .15s;}#sequence-preloader img:nth-child(3){"+prefix+"animation-delay: .3s; animation-delay: .3s;}.preloading-complete{opacity: 0;visibility: hidden;"+prefix+"transition-duration: 1s; transition-duration: 1s;}</style>");
			$(prependTo).prepend('<div id="sequence-preloader"><div class="preloading"><img src="../images/sequence-loader.png" alt="" />    <img src="../images/sequence-loader.png" alt="" />    <img src="../images/sequence-loader.png" alt="" /></div></div>');
		}
	},
